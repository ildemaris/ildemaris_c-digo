...
export default function HomeScreen({ navigation }) {
  ...
  const sincronizarReceitas = async () => {
    setCarregando(true);
    try {
      const response = await fetch('https://raw.githubusercontent.com/ildemaris/ildemaris_c-digo/refs/heads/main/receitas.json');
